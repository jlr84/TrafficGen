...
echo '\n' && date && ~/mininet/TrafficGen/ITGscripts/ITGSendTCP_cbr 10.0.0.11 10.0.0.21   01000 300000 34 0>/dev/null && \
\
...
echo '\n' && date && ~/mininet/TrafficGen/ITGscripts/ITGSendTCP_cbr 10.0.0.12 10.0.0.21  02000 300000 34 0>/dev/null && \
\
...
echo '\n' && date && ~/mininet/TrafficGen/ITGscripts/ITGSendTCP_cbr 10.0.0.13 10.0.0.21  03000 300000 34 0>/dev/null && \
\
